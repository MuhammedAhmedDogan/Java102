...
public class AdminView extends Layout {
    ...
    private JButton btn_model_serch;
    ...
    private void loadModelComponent() {
        ...
        this.btn_model_serch.addActionListener(e -> {
            ComboItem selectedBrand = (ComboItem) this.cmb_s_model_brand.getSelectedItem();
            int brandId = 0;
            if (selectedBrand != null) {
                brandId = selectedBrand.getKey();
            }
            ArrayList<Model> modelListBySearch = this.modelManager.serchForTable(brandId,
        ...
        this.btn_filter_clear.addActionListener(e -> {
    ...
    public void loadModelFilterBrand() {
        ...
        for (Brand obj : this.brandManager.findAll()) {
